> [!CAUTION]
> **Pre-Alpha Status:** This project is under active development. Breaking changes are expected; APIs and data structures may change significantly. We are working doggedly toward an initial release. Comments and feedback are most welcome! 🚧
