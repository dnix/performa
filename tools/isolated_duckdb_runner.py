...
"""
Isolated DuckDB Runner
- Uses explicit DuckDB ledger class
...
# Force DuckDB backend for all alias-based imports
os.environ["USE_DUCKDB_LEDGER"] = "true"

# Explicit imports - avoid env vars for module resolution but use alias for type consistency
from performa.core.ledger import Ledger as DuckDBLedger
