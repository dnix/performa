...
from performa.reporting.debug import (
    _classify_performa_object,
    _handle_financing_plan,
    _handle_generic_object,
    _handle_primitive_object,
    _handle_pydantic_object,
...
class TestPolymorphicDebugUtility:
    ...
    def test_dump_valuation_object(self):
        ...
        result = dump_performa_object(valuation, exclude_defaults=False)  # Include defaults to see all fields
...
class TestObjectHandlers:
    ...
    def test_handle_primitive_object(self):
        ...
        result = _handle_primitive_object(timeline, exclude_defaults=True, exclude_unset=False)
    ...
    def test_handle_pydantic_object_with_computed(self):
        ...
        pattern = ResidentialDevelopmentPattern(
            ...
            land_cost=5_000_000,
            total_units=100,
            unit_mix=[{"unit_type": "1BR", "count": 100, "avg_sf": 650, "target_rent": 1500}],
        ...
        result = _handle_pydantic_object(pattern, exclude_defaults=True, exclude_unset=False, include_computed=True)
    ...
    def test_handle_financing_plan(self):
        ...
        result = _handle_financing_plan(financing_plan, exclude_defaults=True, exclude_unset=False)
...
class TestFormattingUtilities:
    ...
    def test_format_performa_object_with_pattern(self):
        ...
        pattern = ResidentialDevelopmentPattern(
            ...
            land_cost=6_000_000,
            total_units=80,
            unit_mix=[{"unit_type": "Studio", "count": 80, "avg_sf": 500, "target_rent": 1200}],
...
class TestParameterHandling:
    ...
    def test_exclude_unset_parameter(self):
        ...
        pattern = ResidentialDevelopmentPattern(
            ...
            land_cost=5_000_000,
            total_units=50,
            unit_mix=[{"unit_type": "1BR", "count": 50, "avg_sf": 650, "target_rent": 1400}],
            construction_cost_per_unit=150_000,
    ...
    def test_include_computed_parameter(self):
        ...
        pattern = ResidentialDevelopmentPattern(
            ...
            land_cost=4_000_000,
            total_units=60,
            unit_mix=[{"unit_type": "2BR", "count": 60, "avg_sf": 800, "target_rent": 1600}],
            construction_cost_per_unit=160_000,
            construction_ltc_ratio=0.70,
            permanent_ltv_ratio=0.75,
            hold_period_years=5,
...
class TestCashOutRefinancingValidation:
    ...
    def test_construction_to_permanent_cash_out_detection(self):
        ...
        if facilities and "_class_name" in facilities[0]:
            construction_facility = next(f for f in facilities if f["_class_name"] == "ConstructionFacility")
            permanent_facility = next(f for f in facilities if f["_class_name"] == "PermanentFacility")
        else:
    ...
    def test_no_cash_out_scenario_detection(self):
        ...
        cash_out = permanent_facility["loan_amount"] - construction_facility["loan_amount"]
    ...
    def test_debug_utility_guides_financing_analysis(self):
        ...
        formatted_result = format_performa_object(financing_plan, "Development Financing Analysis")
        ...
        if facilities and "_class_name" in facilities[0]:
            construction_amount = next(f["loan_amount"] for f in facilities if f["_class_name"] == "ConstructionFacility") 
            permanent_amount = next(f["loan_amount"] for f in facilities if f["_class_name"] == "PermanentFacility")
        else:
