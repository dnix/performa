...
def mock_construction_plan(mock_capital_item):
    ...
    plan.capital_items = [
        ...
        Mock(
            name="Developer Fee",
            work_type="developer",
            value=400000.0,  # Changed from "developer fee" to "developer"
            timeline=Mock(start_date=date(2024, 1, 1), end_date=date(2024, 12, 31)),
            draw_schedule=Mock(),
        ),
    ]
...
@pytest.fixture
def mock_development_project(
    mock_construction_plan, mock_development_program, mock_blueprint
):
...
class TestReportTemplate:
    ...
    def test_report_template_creation(self):
        ...
        template = ReportTemplate(
            name="Test Template", template_type="sources_and_uses"
        )
    ...
    def test_report_template_with_custom_options(self, sample_report_template):
        ...
        assert sample_report_template.terminology == {
...
class TestIndustryMetrics:
    ...
    def test_stabilization_metrics(self):
        ...
        assert (
            abs(result["occupancy_to_stabilization"] - 0.20) < 0.001
...
class TestSourcesAndUsesReport:
    ...
    def test_sources_and_uses_report_creation_no_name(
        self, minimal_development_project
    ):
    ...
    def test_sources_and_uses_factory_method(
        self, mock_development_project, sample_report_template
    ):
        """Test factory method creation."""
        report = SourcesAndUsesReport.from_development_project(
            mock_development_project, sample_report_template
        )
    ...
    def test_categorize_project_uses(self, mock_development_project):
        ...
        report = SourcesAndUsesReport(mock_development_project)
        uses = report._categorize_project_uses(
            mock_development_project.construction_plan
        )
        ...
        assert (
            uses["soft_costs"] == 300000.0
        )  # Architectural Fees item (work_type="design")
...
class TestDevelopmentSummaryReport:
    ...
    def test_development_summary_factory_method(self, mock_development_project):
        """Test factory method creation."""
        report = DevelopmentSummaryReport.from_development_project(
...
class TestConstructionDrawReport:
    ...
    def test_construction_draw_factory_method(self, mock_development_project):
        ...
        report = ConstructionDrawReport.from_development_project(
            mock_development_project, period
        )
...
class TestLeasingStatusReport:
    ...
    def test_leasing_status_factory_method(self, mock_development_project):
        ...
        report = LeasingStatusReport.from_development_project(
            mock_development_project, as_of_date
        )
    ...
    def test_generate_data_comprehensive(self, mock_development_project):
        ...
        expected_absorption_items = [
            "Target Monthly Absorption",
            "Actual Monthly Absorption",
            "Absorption vs Target",
            "Pipeline (Under LOI)",
            "Pipeline Value",
        ]
    ...
    def test_calculate_leasing_metrics_success(self, mock_development_project):
        ...
        expected_metrics = [
            ...
            "avg_lease_term",
            "annual_rent_roll",
            "monthly_absorption_target",
            "actual_monthly_absorption",
            "absorption_performance",
            "pipeline_area",
            "pipeline_value",
            "months_to_stabilization",
        ]
    ...
    def test_calculate_leasing_metrics_exception_fallback(
        self, minimal_development_project
    ):
    ...
    def test_generate_market_comparables(self, mock_development_project):
        ...
        expected_keys = [
            ...
            "Submarket Absorption (Last 12M)",
            "New Supply Pipeline",
            "Rent Growth (Last 12M)",
            "Market Ranking",
        ]
        for key in expected_keys:
    ...
    def test_generate_forward_outlook(self, mock_development_project):
        ...
        expected_keys = [
            "Q4 2024 Projected Occupancy",
            "Q1 2025 Projected Occupancy",
...
class TestReportIntegration:
    ...
    def test_report_error_resilience(self, mock_development_project):
        ...
        problematic_project.property_type.__str__ = Mock(
            side_effect=Exception("Property type error")
        )
