...
class TestDispositionCashFlowComputation:
    ...
    def test_compute_cf_basic_scenario(self, sample_timeline: Timeline, sample_context: AnalysisContext):
    ...
    def test_compute_cf_zero_value(self, sample_timeline: Timeline, sample_context: AnalysisContext):
    ...
    def test_compute_cf_large_value(self, sample_timeline: Timeline, sample_context: AnalysisContext):
...
class TestDispositionCashFlowIntegration:
    ...
    def test_timeline_period_index_compatibility(self, sample_timeline: Timeline, sample_context: AnalysisContext):
...
class TestDispositionCashFlowEdgeCases:
    ...
    def test_very_long_timeline(self, sample_context: AnalysisContext):
        ...
        long_timeline = Timeline(start_date=date(2024, 1, 1), duration_months=600)  # 50 years
    ...
    def test_fractional_values(self, sample_timeline: Timeline, sample_context: AnalysisContext):
...
class TestDispositionDocumentationExamples:
    ...
    def test_docstring_example(self, sample_timeline: Timeline, sample_context: AnalysisContext):
