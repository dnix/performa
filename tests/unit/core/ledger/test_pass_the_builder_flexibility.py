...
class TestLedgerFlexibility:
    ...
    def test_asset_analysis_with_custom_ledger(self, office_property, timeline, settings):
    ...
    def test_deal_analysis_with_precomputed_asset(self, office_property, timeline, settings):
    ...
    def test_deal_analysis_with_custom_ledger(self, office_property, timeline, settings):
    ...
    def test_priority_order_asset_analysis_wins(self, office_property, timeline, settings):
