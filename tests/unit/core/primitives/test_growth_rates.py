...
from performa.core.primitives import GrowthRates, PercentageGrowthRate


# PercentageGrowthRate Tests
def test_growth_rate_instantiation():
    ...
    PercentageGrowthRate(name="Dict", value=dict_val)
...
def test_growth_rate_validation_fails():
    ...
    with pytest.raises(ValidationError):
        PercentageGrowthRate(name="Bad Dict", value=bad_dict)
