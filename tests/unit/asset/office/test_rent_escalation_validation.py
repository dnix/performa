...
class TestRentEscalationValidation(unittest.TestCase):
    ...
    def test_percentage_escalation_with_invalid_float_rate(self):
        ...
        for rate in invalid_rates:
            ...
            self.assertTrue(
                "between 0 and 1" in error_text or 
                "greater than or equal to 0" in error_text or
                "less than or equal to 1" in error_text,
    ...
    def test_fixed_escalation_with_invalid_float_rate(self):
        ...
        for rate in invalid_rates:
            ...
            error_text = str(cm.exception)
            self.assertTrue(
                "must be positive" in error_text or 
                "greater than or equal to 0" in error_text,
                f"Unexpected error message: {error_text}"
            )
    ...
    def test_percentage_escalation_with_wrong_rate_object_type(self):
        ...
        self.assertIn("Cannot use FixedGrowthRate with percentage escalation", str(cm.exception))
    ...
    def test_fixed_escalation_with_wrong_rate_object_type(self):
        ...
        self.assertIn("Cannot use PercentageGrowthRate with fixed escalation", str(cm.exception))
    ...
    def test_rate_value_property_with_rate_object_raises_error(self):
        ...
        self.assertIn("Cannot get simple rate value from rate object", str(cm.exception))
