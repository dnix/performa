...
class TestRolloverErrorHandling:
    ...
    def test_missing_target_absorption_plan_id(self):
        ...
        property_model = ResidentialProperty(
            ...
            address=Address(street="123 Error St", city="Test", state="CA", zip_code="90210", country="USA"),
            gross_area=800.0,
        ...
        assert month_6_revenue == 0, "Should have no revenue later (unit didn't transform)"
    ...
    def test_circular_reference_prevention(self):
        ...
        property_model = ResidentialProperty(
            ...
            address=Address(street="123 Circular St", city="Test", state="CA", zip_code="90210", country="USA"),
            gross_area=800.0,
            net_rentable_area=800.0,
            unit_mix=ResidentialRentRoll(unit_specs=[unit_spec]),
            capital_plans=[],
