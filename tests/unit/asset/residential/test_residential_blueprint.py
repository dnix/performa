...
from performa.core.base import DevelopmentBlueprintBase, FixedQuantityPace
...
def test_residential_blueprint_instantiation():
    ...
    rollover_profile = ResidentialRolloverProfile(
        ...
        renewal_terms=ResidentialRolloverLeaseTerms(
            market_rent=2800.0, renewal_rent_increase_percent=0.03
        ),
    )
    ...
    absorption_plan = ResidentialAbsorptionPlan.with_typical_assumptions(
        ...
        pace=FixedQuantityPace(
            type="FixedQuantity", quantity=10, unit="Units", frequency_months=1
        ),
        leasing_assumptions=ResidentialDirectLeaseTerms(
            monthly_rent=2800.0, lease_term_months=12, security_deposit_months=1.0
        ),
...
def test_residential_blueprint_unit_mix_aggregation():
    ...
    absorption_plan = ResidentialAbsorptionPlan.with_typical_assumptions(
        ...
        space_filter=ResidentialUnitFilter(),
        pace=FixedQuantityPace(
            type="FixedQuantity", quantity=15, unit="Units", frequency_months=2
        ),
        leasing_assumptions=ResidentialDirectLeaseTerms(
            monthly_rent=3000.0, lease_term_months=12
        ),
        start_date_anchor="AnalysisStart",
    )
    ...
    total_units = sum(
        unit_group.unit_count for unit_group in blueprint.vacant_inventory
    )
...
def test_residential_blueprint_to_stabilized_asset():
    ...
    timeline = Timeline.from_dates(
        start_date=date(2024, 1, 1), end_date=date(2029, 12, 31)
    )
    ...
    rollover_profile = ResidentialRolloverProfile(
        ...
        renewal_terms=ResidentialRolloverLeaseTerms(
            market_rent=3500.0, renewal_rent_increase_percent=0.04
        ),
    )
    ...
    absorption_plan = ResidentialAbsorptionPlan.with_typical_assumptions(
        ...
        leasing_assumptions=ResidentialDirectLeaseTerms(
            monthly_rent=3500.0, lease_term_months=12, security_deposit_months=2.0
        ),
        start_date_anchor="AnalysisStart",
    )
...
def test_residential_blueprint_relative_timeline_validation():
    ...
    absorption_plan = ResidentialAbsorptionPlan.with_typical_assumptions(
        ...
        space_filter=ResidentialUnitFilter(),
        pace=FixedQuantityPace(
            type="FixedQuantity", quantity=5, unit="Units", frequency_months=1
        ),
    ...
    relative_timeline = Timeline.from_relative(months_until_start=6, duration_months=60)
...
def test_residential_blueprint_absorption_plan_validation():
    ...
    valid_plan = ResidentialAbsorptionPlan.with_typical_assumptions(
        ...
        space_filter=ResidentialUnitFilter(),
        pace=FixedQuantityPace(
            type="FixedQuantity", quantity=8, unit="Units", frequency_months=2
        ),
        leasing_assumptions=ResidentialDirectLeaseTerms(
            monthly_rent=2600.0, lease_term_months=12, security_deposit_months=1.5
        ),
        start_date_anchor="AnalysisStart",
    )
...
def test_residential_blueprint_unit_count_calculation():
    ...
    total_area = sum(
        unit.unit_count * unit.avg_area_sf for unit in blueprint.vacant_inventory
    )
...
def test_residential_blueprint_name_inheritance():
    ...
    absorption_plan = ResidentialAbsorptionPlan.with_typical_assumptions(
        ...
        space_filter=ResidentialUnitFilter(),
        pace=FixedQuantityPace(
            type="FixedQuantity", quantity=50, unit="Units", frequency_months=1
        ),
        leasing_assumptions=ResidentialDirectLeaseTerms(
