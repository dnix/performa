...
class TestAllExpirationScenarios:
    ...
    def _create_base_property(self, rollover_profile, absorption_plans=None):
        ...
        return ResidentialProperty(
            name="Test Property",
            address=Address(street="123 Test St", city="Test", state="CA", zip_code="90210", country="USA"),
            gross_area=800.0,
    ...
    def test_renew_expiration_scenario(self):
        ...
        assert pgr_series.iloc[2] == 2100.0  # Month 3 (renewal in March at renewal terms)
    ...
    def test_vacate_expiration_scenario(self):
        ...
        assert pgr_series.iloc[2] == 2200.0  # Month 3 (Mar 2024) - new tenant at market rent
    ...
    def test_reabsorb_without_target_plan(self):
        ...
        assert pgr_series.iloc[2] == 0.0  # Month 3 (Mar 2024) - lease expires, unit reabsorbed
    ...
    def test_reabsorb_with_target_plan(self):
        ...
        assert pgr_series.iloc[2] == 0.0  # Month 3 (Mar 2024) - lease expires, downtime starts
    ...
    def test_mixed_expiration_scenarios_same_property(self):
        ...
        property_model = ResidentialProperty(
            name="Mixed Property",
            address=Address(street="123 Mixed St", city="Test", state="CA", zip_code="90210", country="USA"),
            gross_area=2400.0,
...
class TestExpirationScenarioEdgeCases:
    ...
    def test_zero_downtime_market_scenario(self):
        ...
        property_model = ResidentialProperty(
            ...
            address=Address(street="123 NoGap St", city="Test", state="CA", zip_code="90210", country="USA"),
            gross_area=800.0,
            net_rentable_area=800.0,
            unit_mix=ResidentialRentRoll(unit_specs=[unit_spec]),
            capital_plans=[],
    ...
    def test_very_long_downtime_scenario(self):
        ...
        property_model = ResidentialProperty(
            ...
            address=Address(street="123 LongGap St", city="Test", state="CA", zip_code="90210", country="USA"),
            gross_area=800.0,
            net_rentable_area=800.0,
            unit_mix=ResidentialRentRoll(unit_specs=[unit_spec]),
            capital_plans=[],
