...
class TestDealModel:
    ...
    def test_deal_creation_with_development_project(
        self, development_project, sample_acquisition
    ):
    ...
    def test_deal_type_detection_development(
        self, development_project, sample_acquisition
    ):
    ...
    def test_deal_components_validation(self, development_project, sample_acquisition):
        ...
        deal = Deal(
            name="Test Deal", asset=development_project, acquisition=sample_acquisition
        )
