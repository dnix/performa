...
class TestPartnershipCapitalMode:
    ...
    def test_mixed_mode_rejection(self):
        ...
        assert "Either all partners must have explicit commitments or none" in str(
            exc_info.value
        )
...
class TestPartnershipCapitalShares:
    ...
    def test_capital_shares_explicit_mode_sweat_equity(self):
        ...
        gp = Partner(
            name="Developer GP", kind="GP", share=0.20, capital_commitment=5_000_000
        )
        lp = Partner(
            name="Capital LP", kind="LP", share=0.80, capital_commitment=95_000_000
        )
...
class TestPartnershipCommitmentValidation:
    ...
    def test_validate_commitments_sufficient_capital(self):
        ...
        partnership.validate_commitments(
            required_equity=40_000_000
        )  # Need 40M, have 50M
...
class TestPartnershipIntegrationWithExistingFeatures:
    ...
    def test_existing_properties_still_work_explicit_mode(self):
        ...
        gp = Partner(
            name="Rich GP", kind="GP", share=0.15, capital_commitment=5_000_000
        )
        lp = Partner(
            name="Richer LP", kind="LP", share=0.85, capital_commitment=45_000_000
        )
    ...
    def test_get_partner_by_name_still_works(self):
        ...
        gp = Partner(
            name="Specific GP", kind="GP", share=0.40, capital_commitment=12_000_000
        )
        lp = Partner(
            name="Specific LP", kind="LP", share=0.60, capital_commitment=18_000_000
        )
