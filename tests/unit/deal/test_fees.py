...
class TestDealFee:
    ...
    def test_fee_defaults(self, timeline, sample_partner):
        ...
        fee = DealFee(
            name="Developer Fee", value=100_000, payee=sample_partner, timeline=timeline
        )
    ...
    def test_calculate_total_fee_fixed(self, timeline, sample_partner):
        ...
        fee = DealFee(
            name="Developer Fee", value=500_000, payee=sample_partner, timeline=timeline
        )
    ...
    def test_fee_small_values(self, timeline, sample_partner):
        ...
        fee = DealFee(
            name="Developer Fee", value=5_000, payee=sample_partner, timeline=timeline
        )
    ...
    def test_fee_various_ranges(self, timeline, sample_partner):
        ...
        # Test small fee
        fee_small = DealFee(
            name="Developer Fee", value=1_000, payee=sample_partner, timeline=timeline
        )
        ...
        # Test typical range
        fee_typical = DealFee(
            name="Developer Fee", value=750_000, payee=sample_partner, timeline=timeline
        )
    ...
    def test_fee_uid_generation(self, timeline, sample_partner):
        ...
        fee1 = DealFee(
            name="Fee 1", value=100_000, payee=sample_partner, timeline=timeline
        )
        fee2 = DealFee(
            name="Fee 2", value=200_000, payee=sample_partner, timeline=timeline
        )
    ...
    def test_dict_value_validation(self, timeline, sample_partner):
        ...
        assert "date_from_datetime_inexact" in str(
            exc_info.value
        ) or "must be dates" in str(exc_info.value)
...
class TestDealFeeDrawScheduleIntegration:
    ...
    def test_create_split_fee_validation_errors(self, timeline, sample_partner):
        ...
        with pytest.raises(ValueError, match="Must specify either"):
            DealFee.create_split_fee(
                name="Fee", value=1_000_000, payee=sample_partner, timeline=timeline
            )
    ...
    def test_completion_fee_calculation_with_draw_schedule(
        self, timeline, sample_partner
    ):
