...
class TestWaterfallLogicValidation:
    ...
    def test_cash_flow_conservation_principle(self):
        ...
        for scenario_cash_flows in scenarios:
            periods = pd.period_range('2024-01', periods=len(scenario_cash_flows), freq='M')
    ...
    def test_preferred_return_priority_principle(self):
        ...
        print(f"   GP promote: {gp_actual_share:.1%} vs {gp_pro_rata_share:.1%} pro-rata")
    ...
    def test_hurdle_progression_logic(self):
        ...
        promote = WaterfallPromote(
            pref_hurdle_rate=0.08,  # 8% preferred return
            tiers=[
                WaterfallTier(tier_hurdle_rate=0.12, promote_rate=0.20),  # 12% hurdle, 20% promote
                WaterfallTier(tier_hurdle_rate=0.16, promote_rate=0.35),  # 16% hurdle, 35% promote
            ],
    ...
    def test_mathematical_precision_consistency(self):
        ...
        base_gp_total = base_results["partner_distributions"]["GP"]["total_distributions"]
        base_lp_total = base_results["partner_distributions"]["LP"]["total_distributions"]
        ...
        higher_gp_total = higher_results["partner_distributions"]["GP"]["total_distributions"]
        higher_lp_total = higher_results["partner_distributions"]["LP"]["total_distributions"]
