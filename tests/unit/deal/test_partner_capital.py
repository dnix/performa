...
class TestPartnerCapitalCommitment:
    ...
    def test_partner_zero_commitment(self):
        ...
        partner = Partner(
            name="Zero Commitment GP",
            kind="GP",
            share=0.10,
            capital_commitment=0.0
        )
    ...
    def test_multiple_partners_different_commitments(self):
        ...
        gp_with_commitment = Partner(
            name="GP with Capital",
            kind="GP",
            share=0.20,
            capital_commitment=2_000_000
        )
        
        gp_without_commitment = Partner(
            name="GP without Capital", 
            kind="GP",
            share=0.10
        )
        
        lp_with_commitment = Partner(
            name="LP with Capital",
            kind="LP",
            share=0.70,
            capital_commitment=35_000_000
        )
