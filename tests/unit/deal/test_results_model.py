...
class TestResultsModel:
    ...
    def test_comprehensive_audit_trail(self, mock_deal, timeline, settings):
        ...
        assert isinstance(fee_details.fee_cash_flows_by_partner["Developer GP"], pd.Series)
    ...
    def test_complex_fee_structure(self, partners, timeline, settings):
        ...
        gp_result = partner_results["Developer GP"]
        assert len(gp_result.fee_details) == 3  # Acquisition, Asset Management, Disposition
        ...
        # Test totals
        expected_gp_fees = 100000 + 60000 + 75000  # Acquisition + Asset Management + Disposition
