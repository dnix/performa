...
class TestThirdPartyOrchestration:
    ...
    def test_mixed_fee_processing(self, timeline, settings, developer_partner, investor_partner, 
                                  architect_third_party, broker_third_party):
        ...
        total_project_cost = fee_details["total_partner_fees"] + fee_details["total_third_party_fees"]
        ...
        assert total_fee_reduction <= expected_total_fees  # May be limited by available cash flow
    
    def test_third_party_only_fees(self, timeline, settings, developer_partner, architect_third_party):
    ...
    def test_partner_only_fees(self, timeline, settings, developer_partner, architect_third_party):
