...
def create_deal_context(timeline, settings, ledger_builder, deal):
...
def mock_construction_facility():
    ...
    def mock_compute_cf(context):
        ...
        context.ledger_builder.add_series(-debt_service, debt_service_metadata)
...
class TestDebtAnalyzerBasic:
    ...
    def test_debt_analyzer_can_be_instantiated(
        self, mock_deal_without_financing, sample_timeline, sample_settings
    ):
...
class TestAnalyzeFinancingStructureNoFinancing:
    ...
    def test_analyze_financing_structure_no_financing(
        self,
        ...
        result = analyzer.analyze_financing_structure(
            property_value_series=pd.Series(
                [1000000.0] * 60, index=sample_timeline.period_index
            ),
    ...
    def test_analyze_financing_structure_no_financing_immutable_state(
        self,
        mock_deal_without_financing,
        sample_timeline,
        sample_settings,
        ...
        result2 = analyzer.analyze_financing_structure(
            property_value_series=pd.Series(
                [2000000.0] * 60, index=sample_timeline.period_index
            ),
...
class TestAnalyzeFinancingStructureWithFinancing:
    ...
    def test_analyze_financing_structure_basic_financing(
        self,
        ...
        result = analyzer.analyze_financing_structure(
            property_value_series=pd.Series(
                [5000000.0] * 60, index=sample_timeline.period_index
            ),
    ...
    def test_analyze_financing_structure_multiple_facilities(
        self,
        mock_deal_with_financing,
        mock_construction_facility,
        ...
        result = analyzer.analyze_financing_structure(
            property_value_series=pd.Series(
                [8000000.0] * 60, index=sample_timeline.period_index
            ),
    ...
    def test_analyze_financing_structure_facility_errors(
        self,
        mock_deal_with_financing,
        sample_timeline,
        sample_settings,
    ...
    def test_analyze_financing_structure_facility_without_methods(
        self,
        mock_deal_with_financing,
        sample_timeline,
        sample_settings,
...
class TestDSCRCalculations:
    ...
    def test_calculate_dscr_metrics_with_financing(
        ...
        analyzer._process_facilities(sample_ledger_builder, deal_context)
    ...
    def test_calculate_dscr_metrics_with_error_handling(
        self, mock_deal_with_financing, sample_timeline, sample_settings
    ):
...
class TestPrivateMethodsAndUtilities:
    ...
    def test_extract_noi_time_series(
        self,
        mock_deal_with_financing,
        sample_timeline,
        sample_settings,
...
class TestRefinancingTransactions:
    ...
    def test_analyze_financing_structure_with_refinancing(
        self,
        mock_deal_with_financing,
        sample_timeline,
        sample_settings,
...
class TestEdgeCasesAndErrorHandling:
    ...
    def test_facility_without_name(
        self,
        mock_deal_with_financing,
        sample_timeline,
        sample_settings,
    ...
    def test_facility_without_description(
        self,
        mock_deal_with_financing,
        sample_timeline,
        sample_settings,
...
class TestIntegrationScenarios:
    ...
    def test_full_development_financing_scenario(
        self,
        mock_deal_with_financing,
        mock_construction_facility,
        mock_permanent_facility_with_refinancing,
        ...
        property_values = pd.Series(
            [3000000 + i * 50000 for i in range(60)], index=sample_timeline.period_index
        )

        # Mock NOI that grows over time
        noi_values = pd.Series(
            [80000 + i * 2000 for i in range(60)], index=sample_timeline.period_index
        )
    ...
    def test_high_leverage_scenario(
        self,
        mock_deal_with_financing,
        sample_timeline,
        sample_settings,
        ...
        high_debt_facility.calculate_loan_proceeds = lambda timeline: pd.Series(
        ...
        def high_debt_compute_cf(context):
            ...
            debt_service_metadata = SeriesMetadata(
                ...
                source_id=uuid4(),
                asset_id=uuid4(),  # Use generic asset_id for this test
                pass_num=CalculationPhase.FINANCING.value,
            )
            context.ledger_builder.add_series(debt_service_ledger_series, debt_service_metadata)
        ...
        result = analyzer.analyze_financing_structure(
            property_value_series=pd.Series(
                [15000000.0] * 60, index=sample_timeline.period_index
            ),
            noi_series=pd.Series([100000.0] * 60, index=sample_timeline.period_index),
            unlevered_analysis=sample_unlevered_analysis,
            ledger_builder=sample_ledger_builder,
