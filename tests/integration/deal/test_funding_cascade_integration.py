...
class TestMultiTrancheFundingIntegration:
    ...
    def test_senior_junior_tranche_funding_priority(self):
        ...
        facility = ConstructionFacility(
            name="Multi-Tranche Construction",
        ...
        assert abs(total_proceeds - expected_total) < 1000, \
    ...
    def test_interest_compounding_integration(self):
        ...
        facility = ConstructionFacility(
            ...
            tranches=[DebtTranche(
                ...
                ltc_threshold=0.70,
                interest_rate=InterestRate(details=FixedRate(rate=0.08)),  # 8% for visibility
                fee_rate=0.01
            )],
    ...
    def test_ltc_constraint_enforcement(self):
        ...
        assert total_proceeds <= max_allowed * 1.01, \
        ...
        assert total_proceeds >= max_allowed * 0.95, \
...
class TestFundingCascadeComponentIntegration:
    ...
    def test_debt_proceeds_equal_debt_draws(self):
        ...
        draws = ledger[
            ledger['item_name'].str.contains('Draw', case=False)
        ]['amount'].sum()
        ...
        assert proceeds <= max_expected * 1.01, \
