...
class TestDealAnalysisPipeline:
    ...
    def test_pipeline_integration_basic_flow(
        self, mock_simple_deal, timeline, settings
    ):
        """
    ...
    def test_result_model_validation_through_pipeline(
        self, mock_deal_with_fees, timeline, settings
    ):
        """
    ...
    def test_fee_accounting_through_pipeline(
        self, mock_deal_with_fees, timeline, settings
    ):
        """
    ...
    def test_partnership_distributions_with_real_ledger(
        self, mock_simple_deal, timeline, settings
    ):
        """
    ...
    def test_enhanced_results_model_validation(
        self, mock_deal_with_fees, timeline, settings
    ):
        """
    ...
    def test_ledger_integration_throughout_pipeline(
        self, mock_simple_deal, timeline, settings
    ):
        """
    ...
    def test_complex_fee_structure_end_to_end(
        self, mock_deal_with_fees, timeline, settings
    ):
        """
    ...
    def test_zero_fees_handling_through_pipeline(
        self, mock_simple_deal, timeline, settings
    ):
        """
    ...
    def test_pydantic_validation_with_real_data(
        self, mock_deal_with_fees, timeline, settings
    ):
        """
