...
class TestFeeAccountingIntegration:
    ...
    def test_fee_priority_payment_logic(
        self, multi_partner_structure, complex_fee_scenarios, timeline, settings
    ):
        """
    ...
    def test_multi_payee_fee_allocation(
        self, multi_partner_structure, complex_fee_scenarios, timeline, settings
    ):
        """
    ...
    def test_fee_timing_distribution_logic(
        self, multi_partner_structure, complex_fee_scenarios, timeline, settings
    ):
        """
    ...
    def test_fee_vs_waterfall_attribution(
        self, multi_partner_structure, complex_fee_scenarios, timeline, settings
    ):
        """
    ...
    def test_dual_entry_fee_accounting(
        self, multi_partner_structure, complex_fee_scenarios, timeline, settings
    ):
        """
    ...
    def test_third_party_fee_tracking(
        self, multi_partner_structure, complex_fee_scenarios, timeline, settings
    ):
        """
    ...
    def test_zero_fees_accounting_logic(
        self, multi_partner_structure, timeline, settings
    ):
        """
    ...
    def test_fee_accounting_mathematical_consistency(
        self, multi_partner_structure, complex_fee_scenarios, timeline, settings
    ):
        """
