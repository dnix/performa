...
class TestCashFlowEngineIntegration:
    ...
    def test_all_equity_funding_through_pipeline(
        self, all_equity_deal, timeline, settings
    ):
        """
    ...
    def test_leveraged_funding_through_pipeline(
        self, leveraged_deal, timeline, settings
    ):
        """
    ...
    def test_cash_flow_structure_through_pipeline(
        self, all_equity_deal, timeline, settings
    ):
        """
    ...
    def test_interest_calculations_through_pipeline(
        self, leveraged_deal, timeline, settings
    ):
        """
    ...
    def test_funding_cascade_logic_through_pipeline(
        self, leveraged_deal, timeline, settings
    ):
        """
    ...
    def test_cash_flow_conservation_through_pipeline(
        self, all_equity_deal, timeline, settings
    ):
        """
    ...
    def test_disposition_proceeds_integration(
        self, all_equity_deal, timeline, settings
    ):
        """
