...
class TestCapitalValidationGuardrails:
    ...
    def create_test_deal(self, partnership, base_project, base_acquisition, financing=None, name="Test Deal", **deal_updates):
    ...
    def test_critical_capital_shortfall_error(self, base_project, base_acquisition, insufficient_partnership, low_ltc_financing):
    ...
    def test_thin_margin_warning(self, caplog, base_capital_plan, base_project, base_acquisition):
    ...
    def test_excess_equity_warning(self, caplog, base_capital_plan, base_project, base_acquisition, excessive_partnership, high_ltc_financing):
        ...
        with caplog.at_level(logging.WARNING):
            equity_target = self.run_capital_validation_test(deal, total_cost=35_000_000)
    ...
    def test_required_equity_calculation_accuracy(self, base_capital_plan, base_project, base_acquisition, adequate_partnership):
        ...
        test_acquisition = base_acquisition.model_copy(
            update={"name": "Land"}
        )
    ...
    def test_all_equity_deal_validation(self, base_capital_plan, base_project, base_acquisition):
