...
class TestCalculateIRR:
    ...
    def test_calculate_irr_all_negative(self):
        ...
        flows = pd.Series(
            [-1000, -500, -200], index=pd.period_range("2024-01", periods=3, freq="M")
        )
        irr = FinancialCalculations.calculate_irr(flows)
        assert irr is None
    ...
    def test_calculate_irr_all_zeros(self):
        ...
        flows = pd.Series(
            [0, 0, 0], index=pd.period_range("2024-01", periods=3, freq="M")
        )
        irr = FinancialCalculations.calculate_irr(flows)
        assert irr is None
    ...
    def test_calculate_irr_single_flow(self):
        ...
        flows = pd.Series([1000], index=pd.period_range("2024-01", periods=1, freq="M"))
        irr = FinancialCalculations.calculate_irr(flows)
        assert irr is None
    ...
    def test_calculate_irr_breakeven(self):
        ...
        flows = pd.Series(
            [-1000, 1000], index=pd.period_range("2024-01", periods=2, freq="M")
        )
        irr = FinancialCalculations.calculate_irr(flows)
    ...
    def test_calculate_irr_with_nans(self):
        ...
        flows = pd.Series(
            [-1000, np.nan, 1100], index=pd.period_range("2024-01", periods=3, freq="M")
        )
...
class TestCalculateEquityMultiple:
    ...
    def test_calculate_equity_multiple_valid_flows(self):
        ...
        flows = pd.Series(
            [-1000, 2500], index=pd.period_range("2024-01", periods=2, freq="M")
        )
    ...
    def test_calculate_equity_multiple_zero_investment(self):
        ...
        flows = pd.Series(
            [0, 1000], index=pd.period_range("2024-01", periods=2, freq="M")
        )
        multiple = FinancialCalculations.calculate_equity_multiple(flows)
        assert multiple is None
    ...
    def test_calculate_equity_multiple_no_returns(self):
        ...
        flows = pd.Series(
            [-1000, -500], index=pd.period_range("2024-01", periods=2, freq="M")
        )
        multiple = FinancialCalculations.calculate_equity_multiple(flows)
    ...
    def test_calculate_equity_multiple_partial_loss(self):
        ...
        flows = pd.Series(
            [-1000, 600], index=pd.period_range("2024-01", periods=2, freq="M")
        )
        multiple = FinancialCalculations.calculate_equity_multiple(flows)
...
class TestCalculateNPV:
    ...
    def test_calculate_npv_valid_flows(self):
        ...
        flows = pd.Series(
            [-1000, 550, 550], index=pd.period_range("2024-01", periods=3, freq="M")
        )
    ...
    def test_calculate_npv_zero_discount_rate(self):
        ...
        flows = pd.Series(
            [-1000, 600, 500], index=pd.period_range("2024-01", periods=3, freq="M")
        )
    ...
    def test_calculate_npv_invalid_discount_rate(self):
        ...
        flows = pd.Series(
            [-1000, 1100], index=pd.period_range("2024-01", periods=2, freq="M")
        )

        # Test various invalid rates
        assert FinancialCalculations.calculate_npv(flows, "not_a_number") is None
        assert (
            FinancialCalculations.calculate_npv(flows, -1.5) is None
        )  # Less than -100%
    ...
    def test_calculate_npv_high_discount_rate(self):
        ...
        flows = pd.Series(
            [-1000, 2000], index=pd.period_range("2024-01", periods=2, freq="M")
        )
