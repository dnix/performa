...
class TestLedgerTransactionBatching:
    ...
    def test_buffer_accumulation(self, ledger, sample_series, sample_metadata, sample_records):
    ...
    def test_flush_outside_transaction_raises_error(self, ledger):
        ...
        with pytest.raises(RuntimeError, match="flush\\(\\) can only be called within a transaction context"):
            ledger.flush()

    def test_backward_compatibility_non_transactional_use(self, ledger, sample_series, sample_metadata, sample_records):
...
class TestLedgerTransactionBatchingDuckDB:
    ...
    def test_duckdb_buffer_accumulation(self, ledger, sample_series, sample_metadata, sample_records):
    ...
    def test_duckdb_auto_commit_on_context_exit(self, ledger, sample_series, sample_metadata):
    ...
    def test_duckdb_error_handling_and_rollback(self, ledger, sample_series, sample_metadata):
    ...
    def test_duckdb_backward_compatibility_non_transactional_use(self, ledger, sample_series, sample_metadata, sample_records):
