...
def test_complete_development_lifecycle(comprehensive_project, analysis_timeline, global_settings):
...
def test_end_to_end_cash_flow_generation(comprehensive_project, analysis_timeline, global_settings):
