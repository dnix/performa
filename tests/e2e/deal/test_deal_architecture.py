...
class TestDealCentricArchitectureIntegration:
    ...
    def test_deal_model_polymorphic_union(
    ...
    def test_asset_deal_layer_separation(
        ...
        deal = Deal(
            name="Layer Separation Test", asset=asset, acquisition=acquisition_terms
        )
    ...
    def test_architecture_prevents_circular_dependencies(
        self, purified_development_project
    ):
    ...
    def test_industry_standard_terminology_preserved(
        self, purified_development_project
    ):
