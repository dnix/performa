...
class RecoveryMethod(Model):
    ...
    def calculate_recoveries(
        ...
        for recovery in self.recoveries:
            ...
            if self.gross_up and occupancy_rate is not None and occupancy_rate < 1.0:
                # This is simplified - proper implementation would identify variable expenses
                # and apply gross-up only to the variable portion
