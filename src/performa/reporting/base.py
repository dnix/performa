...
class Report(BaseModel, ABC):
    ...
    def translate_term(self, internal_term: str) -> str:
        ...
        return default_mappings.get(internal_term, internal_term.replace("_", " ").title())
...
class IndustryMetrics:
    ...
    @staticmethod
    def calculate_equity_multiple(distributions: float, equity_invested: float) -> float:
    ...
    def stabilization_metrics(
        ...
        occupancy_progress = current_occupancy / target_occupancy if target_occupancy > 0 else 0
