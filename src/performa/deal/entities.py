...
class Entity(Model):
    ...
    kind: Literal["GP", "LP", "Third Party"] = Field(..., description="Entity classification")
...
class ThirdParty(Entity):
    ...
    kind: Literal["Third Party"] = Field(default="Third Party", description="Third party classification")
