...
class Timeline(Model):
    ...
    def align_multiple(
        self, series_dict: Dict[str, pd.Series], fill_value: float = 0.0
    ) -> pd.DataFrame:
        """
